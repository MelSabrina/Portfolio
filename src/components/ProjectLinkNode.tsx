...
export function ProjectLinkNode({ projectId, pos, nodeColor, onMouseDown, onSize, onClick }: Props) {
  ...
  return (
    <div
      ...
      onClick={onClick}
    >
      <span className="link-node__arrow">↗</span>
      <svg
        className="link-node__logo"
        viewBox="250 600 2050 1300"
        fill="currentColor"
        aria-label="Behance"
      >
